...
CREATE TABLE `pasaje` (
  ...
  CONSTRAINT `pasaje_ibfk_1` FOREIGN KEY (`id_usuario`) REFERENCES `usuario` (`id_usuario`),
  CONSTRAINT `pasaje_ibfk_2` FOREIGN KEY (`id_viaje`) REFERENCES `viaje` (`id_viaje`)
...
-- Dump completed on 2025-11-11 18:13:24
